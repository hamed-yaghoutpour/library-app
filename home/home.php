...
<div class="container">
	<h1 class="title">به "کتابخانه من" خوش آمدید.</h1>
	<button class="new_book">
		<svg viewBox="0 0 16 16" class="book_icon" fill="white" xmlns="http://www.w3.org/2000/svg">
	...
	<button class="export_data">
		<svg viewBox="0 0 16 16" class="search_icon" fill="white" xmlns="http://www.w3.org/2000/svg">
		  <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
		  <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
		</svg>
		<b>جستجو در کتابخانه</b>
	</button>
	<button class="settings">
		<svg viewBox="0 0 16 16" class="settings_icon" fill="white" xmlns="http://www.w3.org/2000/svg">
